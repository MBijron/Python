...
# if no arguments are given, install package in current folder
is_setup = len(sys.argv) > 1;
...
install_path = s.command_obj['install'].install_lib if is_setup else Path.scriptpath()
