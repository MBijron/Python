...
class CommandBase:
    ...
    def __check_parameter_business_rules(self):
    ...
    def __appoint_parameter_values(self, arguments):
        name = None
    ...
    def __assign_named_parameter(self, name, value):
        for parameter in self.parameters:
            if parameter.get_name() == name:
    ...
    def __assign_next_parameter(self, value):
        for parameter in self.parameters:
